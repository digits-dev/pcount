<?php namespace App\Http\Controllers;
	...
	class AdminItemsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    */
        ...
        {
            return json_encode(Item::where('items.digits_code',$request->item_code)
                ->orWhere('items.upc_code',$request->item_code)
                ->orWhere('items.upc_code2',$request->item_code)
                ->orWhere('items.upc_code3',$request->item_code)
                ->orWhere('items.upc_code4',$request->item_code)
                ->orWhere('items.upc_code5',$request->item_code)
